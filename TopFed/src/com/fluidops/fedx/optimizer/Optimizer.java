...
import ie.deri.hcls.tcga.optimizer.TCGASourceSelection;
...
public class Optimizer {
	...
	public static TupleExpr optimize(TupleExpr parsed, Dataset dataset, BindingSet bindings, 
			EvaluationStrategyImpl strategy, QueryInfo queryInfo) throws SailException, MalformedQueryException, QueryEvaluationException, RDFParseException {
